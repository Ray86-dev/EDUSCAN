...
export default function TopAppBar({ title = "EduScan", userName, avatarUrl }: TopAppBarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-surface border-b border-outline-variant/15 px-6 py-4 pt-[max(1rem,env(safe-area-inset-top))] flex items-center justify-between min-h-[56px]">
